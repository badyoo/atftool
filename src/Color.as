...
package 
{
	...
	public class Color
	{
		...
		public static function premnitiplyAlphaDispose(bitmap:BitmapData):BitmapData{
			var bitmapdata:BitmapData=new BitmapData(bitmap.width,bitmap.height,bitmap.transparent,0);
			for(var x:int=0;x<bitmap.width;x++){
				for(var y:int=0;y<bitmap.height;y++){
					...
					bitmapdata.setPixel32(x,y,Color.argb(a,r,g,b));
				}
			}
			return bitmapdata;
		}
